          ...
          <div className="flex flex-col relative w-full h-[500px] rounded-t-full bg-secondary/80 text-background overflow-hidden group md:mb-12">
            <div className="pt-12 px-6 text-center z-20">
              ...
              <div className="flex flex-wrap justify-center gap-2 mt-4">
                <span className="px-2 py-1 bg-background/10 border border-background/20 rounded font-label-md text-xs text-on-secondary">Product</span>
                <span className="px-2 py-1 bg-background/10 border border-background/20 rounded font-label-md text-xs text-on-secondary">Strategy</span>
                <span className="px-2 py-1 bg-background/10 border border-background/20 rounded font-label-md text-xs text-on-secondary">Vision</span>
              </div>
            </div>
          ...
          <div className="flex flex-col relative w-full h-[550px] rounded-t-full bg-[#cbd5e1] text-background overflow-hidden group">
            <div className="pt-16 px-6 text-center z-20">
              ...
              <p className="font-body-sm text-slate-800 leading-snug">
                Leads all technical architecture across the Finly shared backend. Built the award-winning P-Levy MVP and Fin-Wrapped SDK.
              </p>
              <div className="flex flex-wrap justify-center gap-2 mt-4">
                <span className="px-2 py-1 bg-slate-900/10 border border-slate-900/20 rounded font-label-md text-xs text-slate-900">Engineering</span>
                <span className="px-2 py-1 bg-slate-900/10 border border-slate-900/20 rounded font-label-md text-xs text-slate-900">Architecture</span>
                <span className="px-2 py-1 bg-slate-900/10 border border-slate-900/20 rounded font-label-md text-xs text-slate-900">Backend</span>
              </div>
            </div>
          ...
          <div className="flex flex-col relative w-full h-[450px] rounded-t-full bg-[#fcd34d] text-background overflow-hidden group md:mb-24">
            <div className="pt-10 px-6 text-center z-20">
              ...
              <p className="font-body-sm text-amber-900 leading-snug">
                Drives full-stack development and systems integration. Ensures offline-first, AI-native principles are embedded in every X-product.
              </p>
              <div className="flex flex-wrap justify-center gap-2 mt-4">
                <span className="px-2 py-1 bg-amber-900/10 border border-amber-900/20 rounded font-label-md text-xs text-amber-900">Full-Stack</span>
                <span className="px-2 py-1 bg-amber-900/10 border border-amber-900/20 rounded font-label-md text-xs text-amber-900">Integration</span>
                <span className="px-2 py-1 bg-amber-900/10 border border-amber-900/20 rounded font-label-md text-xs text-amber-900">AI Systems</span>
              </div>
            </div>
